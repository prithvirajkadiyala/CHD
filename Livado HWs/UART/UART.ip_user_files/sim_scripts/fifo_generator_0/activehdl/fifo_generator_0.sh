...
#
# Generated by Vivado on Sun Nov 26 13:38:14 -0600 2017
...
# Script info
echo -e "fifo_generator_0.sh - Script generated by export_simulation (Vivado v2017.3.1 (64-bit)-id)\n"
...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/prith/Desktop/ECE/CHD/Livado HWs/UART/UART.cache/compile_simlib/activehdl"
  fi
